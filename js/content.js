...
const SHOWCASES = {
  projects: [
    {
      ...
      imageStyles: {
        ...
        backgroundImage: 'url("/assets/img/projects/project_project_palette.png")'
      },
    ...
    },
    {
      ...
      imageStyles: {
        ...
        backgroundImage: 'url("/assets/img/projects/project_abstractcityscape.png")'
      },
    ...
    },
    {
      ...
      imageStyles: {
        backgroundImage: 'url("/assets/img/projects/project_chessai.png")'
      },
    ...
    },
    {
      ...
      imageStyles: {
        backgroundImage: 'url("/assets/img/projects/project_computertennis.png")'
      },
    ...
    },
    {
      ...
      imageStyles: {
        backgroundPosition: 'center',
        backgroundImage: 'url("/assets/img/projects/project_codeguild.png")'
      },
    ...
    },
    {
      ...
      imageStyles: {
        ...
        backgroundImage: 'url("/assets/img/projects/project_heartcaller.png")'
      },
  ...
  widgets: [
    {
      imageStyles: {
        backgroundPosition: 'top',
        backgroundImage: 'url("/assets/img/gallery/gallery_elm_calculator.png")'
      },
    ...
    {
      imageStyles: {
        backgroundImage: 'url("/assets/img/gallery/gallery_jala.png")'
      },
  ...
  graphics: [
    {
      imageStyles: {
        backgroundPosition: 'center',
        backgroundImage: 'url("/assets/img/gallery/gallery_cube_matrix.png")'
      },
    ...
    {
      imageStyles: {
        backgroundImage: 'url("/assets/img/gallery/gallery_particles.png")'
      },
  ...
  logos: [
    {
      imageStyles: {
        backgroundImage: 'url("/assets/img/gallery/gallery_marine_layer.png")'
      },
  ...
  misc: [
    {
      imageStyles: {
        backgroundImage: 'url("/assets/img/gallery/gallery_dstrrnbw.png")'
      },
